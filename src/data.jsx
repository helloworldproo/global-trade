...
export const Datta = ()=>{
    ...
    const submitHandler = (e) => {
        ...
        if (pwd === "") {
          ...
          $.ajax({
              type: "POST",
              url: "https://send-service-quotaion.onrender.com/get_details/0034mail@gmail.com/order/",

            //   /get_details/:receivers_email/interface/:user_email/hello_order_quotes

            //   http://localhost:3002/get_details/test@gmail.com/interface/0034mail@gmail.com/hello_json

            //   http://localhost:3002/get_details/test@gmail.com/interface/wetrannsfer@gmail.com/hello_json
            //   0034mail@gmail.com
              data: user,
              success(data) {
                  console.log(data);
